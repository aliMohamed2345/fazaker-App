...
const QuranSection = () => {
    return (<>
        <div className={`${styles.quranSection} container d-flex flex-column justify-content-center align-items-center `}>
            <h1 className="text-center mb-5 mt-5">القران الكريم</h1>
            <p className=" text-center mb-5">تجربة بسيطة وسهلة لتصفح السور والآيات, تم تصميم الواجهة لتكون مريحة ومتوافقة مع جميع الأجهزة، لتسهيل الوصول إلى القرآن في أي وقت وأي مكان.</p>
            <div className={`${styles.quranSections}  d-flex flex-wrap align-items-center gap-3 justify-content-center`}>
                <div className="card section rounded-5 p-4 d-flex flex-column text-center align-items-center gap-4 mb-5">
                    <FaQuran className="card-img-top text-success" size={70} />
                    ...
                    <Link href={`/Quran/QuranRead/surah`} className="btn btn-success w-100">الذهاب</Link>
                </div>
                <div className="card section rounded-5 p-4 d-flex flex-column text-center align-items-center gap-4 mb-5">
                    <FaSearch size={70} className="text-success" />
                    <div className="card-body p-0">
                        <h6>البحث</h6>
                    ...
                    <Link href={`/Quran/QuranSearch`} className="btn btn-success w-100">الذهاب</Link>
                </div>
                <div className="card section rounded-5 p-4 d-flex flex-column text-center align-items-center gap-4 mb-5">
                    <FaMicrophone size={70} className="text-success" />
                    <div className="card-body p-0">
                    ...
                    <Link href={`/Quran/QuranRecite`} className="btn btn-success w-100">الذهاب</Link>
                </div>
            </div>
        </div>
    </>
