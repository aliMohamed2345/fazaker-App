...
const MainSection = () => {
    ...
    return (<>
        <main className="  mw-100 h-100 container main-section text-center ">
            {/* <div style={{backgroundImage:`url(${CastleBlock})`}} className="w-100">
